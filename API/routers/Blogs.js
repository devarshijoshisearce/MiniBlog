...
router.post('/createBlog',uploadMiddleWare.single('files') , controller.createBlogs);                          //create a blog. data will be passed by a form
...
router.post('/updateBlogbyID', uploadMiddleWare.single('files'), controller.updateBlogsbyID)                      //update a post -> pass postID, authorID, userID, and the same data as createBLogs.
